...
--    일반적으로 CONSTRAINT 명은 『테이블명_컬럼명_CONSTRATIN약자』
--    형식으로 기술한다.
...
HR	SYS_C007128	P	TBL_TEST1					ENABLED	NOT DEFERRABLE	IMMEDIATE	VALIDATED	GENERATED NAME			2020-10-08	HR	SYS_C007128		
*/
...
WHERE TABLE_NAME = 'TBL_TEST1';
--==>> HR	SYS_C007128	TBL_TEST1	COL1	1
...
HR	SYS_C007128	TBL_TEST1	P	COL1
*/
...
-- 컬럼명 데이터타입,
-- 컬럼명 데이터타입,
-- CONSTRAINT CONSTRAINT명 UNIQUE(컬렴명, ...)
...
--==>>
/*
HR	SYS_C007004	TBL_TEST5	P	COL1	(null)  (null)	
HR	SYS_C007005	TBL_TEST5	U	COL2	(null)	(null)
*/
...
--==>>
/*
HR	SYS_C007010	TBL_TEST8	C	COL3	COL3 BETWEEN 0 AND 100	
HR	SYS_C007011	TBL_TEST8	P	COL1		
*/
...
ADD (CONSTRAINT TESTMEMBER_SID_PK PRIMARY KEY(SID)
    ,CONSTRAINT TESTMEMBER_SSN_CK CHECK(SSN LIKE '______-1______' OR SSN LIKE '______-2______'
    OR SSN LIKE '______-3______' OR SSN LIKE '______-4______')
    );
...
INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES(2, '박해진', '950309-2234567', '010-2222-3333');

INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES(3, '허수민', '051111-4234567', '010-1111-1111');

INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES(4, '박다빈', '061111-3234567', '010-1111-1111');

INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES(5, '박민하', '950916-5234567', '010-5555-5555');

INSERT INTO TBL_TESTMEMBER(SID, NAME, SSN, TEL)
VALUES(6, '안혜지', '950302-6234567', '010-6666-6666');
